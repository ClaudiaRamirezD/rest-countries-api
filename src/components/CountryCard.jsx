...
function CountryCard({ country }) {
    return (
        <Link to={`/country/${country.cca3}`} className="country-card">
            <div className="border-1 border-stone-200 bg-[var(--white-dark-mode-text-light-mode-elements)] shadow-lg rounded-md">
                <img
                    className="h-48 w-full overflow-hidden rounded-t-md object-fit"
