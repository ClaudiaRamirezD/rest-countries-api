...
function CountryDetails({ countries }) {
  ...
  return (
      <div className="country-details flex flex-col gap-12 p-8">
          {/* Botón de retroceso */}
          <button
              onClick={() => navigate(-1)}
          ...
          {/* Detalles del país */}
          <div className="flex flex-col gap-10 py-4 md:flex-row">
              <img
                          ...
                          {country.borders ? (
                              country.borders.map((border) => {
                                  ...
                                  return (
                                      <button
                                          key={border}
                                          className="cursor-pointer rounded border border-stone-200 bg-white px-4 py-2 font-[var(--font-primary)] shadow-lg dark:bg-[var(--dark-mode-elements)] dark:text-[var(--dark-mode-text-light-mode-elements)] dark:border-none"
                                          onClick={() =>
